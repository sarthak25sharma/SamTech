            ...
            <div className="list-group gap-4">
              ...
              <label className="list-group-item d-flex gap-2">
                <span>
                  ...
                  <small className="d-block text-body-secondary">
                    <h4>Verifying Voltage Transformation Accuracy:</h4>Verifying Voltage Transformation Accuracy: Another critical test involves measuring the voltage ratio and vector relationship. This test confirms that the transformer accurately transforms voltage levels from input to output while maintaining proper phase relationships between the windings.
                  </small>
                </span>
              </label>
              <label className="list-group-item d-flex gap-2">
              ...
              <label className="list-group-item d-flex gap-2">
                <span>
                  ...
                  <small className="d-block text-body-secondary">
                    <h4>Optimizing Energy Efficiency:</h4>Optimizing Energy Efficiency: No-load loss and current measurement tests are conducted to evaluate the transformer's energy efficiency under no-load conditions. These tests measure the amount of energy lost when the transformer is energized but not delivering any load.
                  </small>
                </span>
              </label>
            </div>
          ...
          <div className="container">
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <div className="card-body">
                    <h3 className="h3main">Highly trained employees</h3>
