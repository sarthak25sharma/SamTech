...
<div className=" founder row g-4 py-5 row-cols-1 row-cols-lg-3">
  <div className="feature col">
    ...
    <h3 className="fs-2 text-body-emphasis">Apurva Tripathi</h3>
    </div>
    <p>He is an Indian entrepreneur and co-founder of Madhusha, with 25 years of experience in the transformer industry. A manager by profession, he has a passion for management and finance, contributing to his company's growth and success. Apurva's diverse interests and skills have significantly bolstered his entrepreneurial achievements.</p>
    
  </div>

  <div className="feature col">
    <div className="fimg feature-icon d-inline-flex align-items-center justify-content-center bg-gradient fs-2 mb-3">
      <img className='w-50 h-50' src='./f2.jpg' alt='founder2'/>
    </div>
    <h3 className="fs-2 text-body-emphasis">Manjari Pandey</h3>
    <p>She is an Indian entrepreneur, co-founder of Madhusha, and a science graduate, Bharatanatyam exponent, and fashion designer. Known for her social work in skill development and women empowerment, she promotes traditional Indian art forms through her clothing brand, focusing on local craftsmanship like Chikankari and Zardozi.</p>
    
  </div>

  <div className="feature col">
    <div className="fimg feature-icon d-inline-flex align-items-center justify-content-center  bg-gradient fs-2 mb-3">
    <img  className='w-50 h-50' src='./f3.jpg' alt='founder3'/>
    </div>
    <h3 className="fs-2 text-body-emphasis">Ashish Pandey</h3>
    <p>He is an Indian entrepreneur and co-founder of Madhusha, with 25 years of experience in the transformer industry. An engineer by profession, he has a passion for art and music, showcasing his paintings in national exhibitions. His creative and diverse nature has contributed to his success as an entrepreneur..</p>
